...
function Show-Menu {
    ...
    Write-Host "4: Press '7' For Compression+Octal+Output."
    Write-Host "5: Press '8' For Dubble-Compression+Octal+Output."
    Write-Host "6: Press '9' For Tripple-Compression+Octal+Output."   
